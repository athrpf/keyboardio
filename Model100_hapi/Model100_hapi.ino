...
KEYMAPS(
  ...
  (___,          CS(0),         CS(1),     CS(2),      CS(3), CS(4), CS(5), 
  ...
  (CS(12), ___, ___, ___, ___, ___, Key_LEDEffectNext,
   ___, ___, ___, CS(2), CS(3), ___, ___,
   ___, ___, ___, CS(4), CS(7), ___,
   ___, ___, ___, ___, ___, ___, ___,
   ___, ___, ___, ___,
   ___,

   M(MACRO_VERSION_INFO),  ___, Key_7, Key_8,      Key_9,              Key_KeypadSubtract, ___,
   ___,                    ___, Key_4, Key_5,      Key_6,              Key_KeypadAdd,      CS(13),
                           ___, Key_1, Key_2,      Key_3,              Key_Equals,         ___,
   ___,                    ___, Key_0, Key_Period, Key_KeypadMultiply, Key_KeypadDivide,   Key_Backslash,
   ___, ___, ___, ___,
   ___),
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_CapsLock,
   ...
   Key_Home, Key_mouseL,       Key_mouseDn, LSHIFT(Key_Tab), Key_Tab, ___,
   Key_End,  Key_PrintScreen,  Key_Insert,  ___,        Key_mouseBtnM, Key_mouseWarpSW,  Key_mouseWarpSE,
   Key_LeftControl, Key_Backspace, Key_LeftGui, Key_LeftShift,
   ___,

   Consumer_ScanPreviousTrack, Key_F6,                 Key_F7,                   Key_F8,                   Key_F9,          Key_F10,          Key_F11,
   Consumer_PlaySlashPause,    Key_PageUp, LCTRL(Key_LeftArrow),     Key_UpArrow,    LCTRL(Key_RightArrow), Key_RightBracket, Key_F12,
                               Key_PageDown,          Key_LeftArrow,            Key_DownArrow,              Key_RightArrow,  ___,              ___,
   Key_PcApplication,          ___,          Key_Home, Key_End, ___,             Key_Backslash,    Key_Pipe,
   Key_RightShift, Key_LeftAlt, Key_Spacebar, Key_RightControl,
   ___)
) // KEYMAPS(
...
const macro_t *macroAction(uint8_t macroIndex, KeyEvent &keyState) {
    switch (macroIndex) {
 ...
 */
 ...
 11: hash, backtick
 12: dollar, tilde
 13: klammeraffe, pointer up
 */

void setup() {
  // setup the top row special programmer dvorak keys
  CS_KEYS(
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_7), LSHIFT(Key_5)),
    kaleidoscope::plugin::CharShift::KeyPair(Key_LeftBracket, Key_7),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_LeftBracket), Key_5),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_RightBracket), Key_3),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_9), Key_1),
    kaleidoscope::plugin::CharShift::KeyPair(Key_Equals, Key_9),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_8), Key_0),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_0), Key_2),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_Equals), Key_4),
    kaleidoscope::plugin::CharShift::KeyPair(Key_RightBracket, Key_6),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_1), Key_8),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_3), Key_Backtick),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_4), LSHIFT(Key_NonUsPound)),
    kaleidoscope::plugin::CharShift::KeyPair(LSHIFT(Key_2), LSHIFT(Key_6)),
  );
